...
<?php
$result = mysqli_query($konek,"SELECT * FROM PERTANYAAN ORDER BY Id");
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title">Masukan Pertanyaan</h4>
        </div>
        ...
        <div class="col-lg-10">
            <input type="text" class="form-control"  placeholder="Masukkan Kata Kunci" name="Kata" required >
          </div>
        </div>
        <div class="form-group">
        <div class="col-lg-10">
            <textarea type="text" class="form-control"  placeholder="Masukkan Pertanyaan" name="Pertanyaan" required ></textarea>
          </div>
        </div>
        <div class="form-group">
